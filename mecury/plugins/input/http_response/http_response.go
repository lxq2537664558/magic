...
func (h *HTTPResponse) Gather(acc agent.Accumulator) error {
	// Set default values
	...
	if h.Address == "" {
		return errors.New("No http address found")
	}
...
func init() {
	agent.AddInput("http_response", &HTTPResponse{})
}
