...
func (p *Postgresql) Gather(acc agent.Accumulator) error {
	var query string
...
func (p *Postgresql) accRow(row scanner, acc agent.Accumulator) error {
...
func init() {
	agent.AddInput("postgresql", &Postgresql{})
}
